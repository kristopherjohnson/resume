...
C++, Go, Rust, C\#, Objective-C, Swift, Java, JavaScript and other
...
C++, Go, Rust, Python, C\#, Swift, Kotlin, JavaScript, TypeScript, C,
...
Led development of a new Go SDK for Ditto. Engineering lead for the Rust
and C++ SDKs. Collaborated with other team members on the SDKs for other
programming languages, including Swift, Kotlin, C\#, JavaScript and
TypeScript. The SDKs target multiple platforms, including iOS, Android,
...
Championed use of Claude Code and other AI tools to research and resolve
issues, to update legacy code to new APIs, and to improve technical
documentation.
